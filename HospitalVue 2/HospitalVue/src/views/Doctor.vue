      ...
      <el-aside width="200px">
        ...
        >
          ...
          <el-menu-item index="orderToday" @click="menuClick('orderToday')">
            <i class="el-icon-news" style="font-size: 18px;"> 门诊接诊</i>
          </el-menu-item>
          <el-menu-item index="doctorQueue" @click="menuClick('doctorQueue')">
            <i class="el-icon-s-promotion" style="font-size: 18px;"> 排队叫号面板</i>
          </el-menu-item>
            <el-menu-item index="doctorOrder" @click="menuClick('doctorOrder')">
            <i class="el-icon-monitor" style="font-size: 18px;"> 历史接诊记录</i>
          </el-menu-item>
            <el-menu-item index="prescriptionList" @click="menuClick('prescriptionList')">
            <i class="el-icon-document" style="font-size: 18px;"> 处方管理</i>
          </el-menu-item>
            <el-menu-item index="inBed" @click="menuClick('inBed')">
            <i class="el-icon-postcard" style="font-size: 18px;"> 门诊观察申请</i>
          </el-menu-item>
