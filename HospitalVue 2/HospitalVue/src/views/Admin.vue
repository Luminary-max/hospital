      ...
      <el-aside width="200px">
        ...
        >
          ...
          <el-menu-item index="doctorList" @click="menuClick('doctorList')">
            ...
            <i class="el-icon-postcard" style="font-size: 18px;"> 门诊挂号管理</i>
          </el-menu-item>
           ...
           <el-menu-item index="checkList" @click="menuClick('checkList')">
            ...
            <i class="el-icon-office-building" style="font-size: 18px;"> 门诊观察管理</i>
          </el-menu-item>
            <el-menu-item index="arrangeIndex" @click="menuClick('arrangeIndex')">
            <i class="el-icon-news" style="font-size: 18px;"> 门诊排班管理</i>
          </el-menu-item>
            <el-menu-item index="queueManage" @click="menuClick('queueManage')">
            <i class="el-icon-s-order" style="font-size: 18px;"> 排队叫号管理</i>
          </el-menu-item>
