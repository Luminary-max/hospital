...
public class DoctorServiceImpl implements DoctorService {
    ...
    public Doctor login(String dId, String dPassword){
        ...
        if (doctor == null) {
            ...
            wrapper.eq("d_name", dId).eq("d_state", 1);
            doctor = this.doctorMapper.selectOne(wrapper);
        }
     ...
     */
    @Override
    public Doctor findDoctor(String dId) {
...
//        List<Doctor> doctors = this.doctorMapper.selectList(queryWrapper);
     ...
     */
    @Override
    public Boolean updateStar(String dId, Double dStar){
