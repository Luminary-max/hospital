...
public class DoctorController {
    ...
    public ResponseData findOrderByNull(@Param(value = "dId") String dId, @RequestParam(value = "oStart") String oStart){
    ...
    public ResponseData updateStar(String dId, Double dStar){
